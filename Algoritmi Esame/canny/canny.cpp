...
{                                                                  // passo la matrice sorgente e la matrice destinazione
...
{ // leggo l'immagine in input e la passo alla funzione Canny
